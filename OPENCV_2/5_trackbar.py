...
def nothing(x):    # trackbar için bu fonksiyon şart.trackbarı oynattığımızda hangi değerde olduğunu geri dönderen bir fonk.
    pass
...
while(1):              # resmin sürekli ekranda kalması için
